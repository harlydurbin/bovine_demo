...
* Sort whole-genome file using `bcftools sort`

```{r,eval=FALSE}
usage_summary(process = "joint_genotyping", keyword = "sort") 
```

```{r, eval=FALSE}
usage_facets(process = "joint_genotyping", keyword = "sort")
```

## `index_sort`

* Index sorted whole-genome file using `bcftools index`

```{r,eval=FALSE}
usage_summary(process = "joint_genotyping", keyword = "index_sort") 
```

```{r, eval=FALSE}
usage_facets(process = "joint_genotyping", keyword = "index_sort")
```
