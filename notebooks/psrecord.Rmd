...
* Run `GATK Validate` on chromosome files
...
* Extract 850K marker set from each chromosome using `bcftools view`
...
```{r,eval=FALSE}
usage_summary(process = "joint_genotyping", keyword = "make_bed") 
```

```{r, eval=FALSE}
usage_facets(process = "joint_genotyping", keyword = "make_bed")
```

## `merge_bed`

```{r,eval=FALSE}
usage_summary(process = "joint_genotyping", keyword = "merge_bed") 
```

```{r, eval=FALSE}
usage_facets(process = "joint_genotyping", keyword = "merge_bed")
```

## `find_dups`

```{r,eval=FALSE}
usage_summary(process = "joint_genotyping", keyword = "find_dups") 
```

```{r, eval=FALSE}
usage_facets(process = "joint_genotyping", keyword = "find_dups")
```